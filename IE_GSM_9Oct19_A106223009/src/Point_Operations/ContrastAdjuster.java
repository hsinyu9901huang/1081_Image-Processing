		...
		do {
			...
			try {
				...
				imp.show();// after running, original image will be shown, and then processed via below
							// plugin.
				//IJ.runPlugIn("Point_Operations.ContrastAdjuster", "balance");//color
				IJ.runPlugIn("Point_Operations.ContrastAdjuster", "w1");//white/black
				//IJ.runPlugIn("Point_Operations.ContrastAdjuster", "");//default(B&C)
